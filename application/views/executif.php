   ...
   <div class="row">
      <div class="col-sm-6 col-md-4">
        <div class="block transparency">
          ...
          <div class="caption">
            <h4>Directeur</h4>
            <p>En tant que directeur de PolyGames, <b>Benjamin Brodeur Mathieu</b>, se doit d’assurer l’organisation de la société dans son ensemble et d’effectuer la liaison entre la société PolyGames, la communauté des étudiants de Polytechnique, la communauté des sociétés techniques de Polytechnique et la direction du département de Génie Informatique/Logiciel.</p>
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-md-4">
